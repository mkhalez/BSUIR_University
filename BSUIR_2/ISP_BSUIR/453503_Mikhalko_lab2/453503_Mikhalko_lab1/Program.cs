...
namespace _453503_Mikhalko_lab1
{
    internal class Program
    {
        ...
        static void Run()
        {
            ...
            system.EntityChanged += journal.LogEvent;
            system.OrderChanged += (object sender, OrderEventArgs e) => 
            ...
            Console.WriteLine("Mila ordered for the amount: " 
                + system.CostOfOrderOfUser("Mila"));
            Console.WriteLine("total cost of orders for New York destination: "
                + system.GetTotalCostInOneDirection("New York"));
            Console.WriteLine("total cost of orders: " 
                + system.GetTotalCostAllOrders());

            Console.WriteLine();
            Console.WriteLine(journal.ShowLog());

            system.AddReview("круто все довезли");
            system.AddReview("спасибо");
            system.AddReview("обожаю сервис, всем советую");
            system.AddReview("мне не понравилось");
            
            Console.WriteLine(system.AllReviews());
            Console.WriteLine(system.RemoveReview("мне не понравилось"));
            Console.WriteLine(system.AllReviews());
            Console.WriteLine(system.RemoveReview("мне не понравилось"));
